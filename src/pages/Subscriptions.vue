<template>
    ...
    <div class="d-flex justify-center align-center pt-24">



        <div class="pa-4 rounded-xl text-center subpixel-antialiased text-xl align-center tracking-wider ">
            ...
            <v-row>
                ...
                <v-col cols="6" sm="2" v-for="subscription in specialSubscriptions" :key="subscription.name"
                    ...
                    <div class="rounded-3xl  transform transition-all hover:-translate-y-6 duration-300 shadow-lxl hover:shadow-2xl hover:shadow-indigo-500/50 backdrop-blur-3xl backdrop-brightness-50 text-white"
                        :class="[
                            $vuetify.display.smAndDown ? 'w-100' : '',
                            { 'grayscale': hoveredSubscription && hoveredSubscription.name !== subscription.name },
                            { 'brightness-125': hoveredSubscription && hoveredSubscription.name === subscription.name }
