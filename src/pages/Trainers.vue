<template>
    ...
    <v-parallax
        ...
        <span v-if="!$vuetify.display.mobile" class="backdrop-blur-xl py-4 text-white "
            :class="darkMode ? ' bg-black/70' : ' bg-white/30'">

            <v-row>
                <v-col cols="12" align="center" jusify="center" class="text-4xl font-weight-black py-10">
                    Select club to see the trainers
                </v-col>
            </v-row>
            ...
            <!-- Footer -->
            <FooterComponent style="position: relative; bottom: 0px; width: 100%;" />
            <!-- Footer -->
        </span>
